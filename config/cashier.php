...
return [
    ...
    */
    ...
    | whose payments require additional verification. You'll need to implement
    | the notification class by extending Cashier's PaymentNotification.
    |
    */
    ...
    | Cashier. You can use any of the paper sizes defined in the Dompdf
    | library's configuration file to set the default invoice paper size.
    |
    */
